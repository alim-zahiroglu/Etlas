...
// showing customer successfully update message in ticket list
document.addEventListener('DOMContentLoaded', function () {
    const updateSuccessToast = document.getElementById('customer_updateSuccessToast');
    setTimeout(function () {
        updateSuccessToast.classList.add('show');
...
// showing customer successfully update message in ticket list
document.addEventListener('DOMContentLoaded', function () {
    const updateSuccessToast = document.getElementById('addBalanceSuccessToast');
    setTimeout(function () {
        updateSuccessToast.classList.add('show');
...
// showing card successfully update message in ticket list
document.addEventListener('DOMContentLoaded', function () {
    const updateSuccessToast = document.getElementById('cardUpdateSuccessToast');
    setTimeout(function () {
        updateSuccessToast.classList.add('show');
